...
public class ContentgridCommonActuatorEndpointsWebSecurityAutoConfiguration {
    ...
    @Bean
    @ConditionalOnClass(HealthEndpoint.class) // spring-boot-health
    ...
    @Bean
    @ConditionalOnClass(PrometheusScrapeEndpoint.class) // spring-boot-micrometer-metrics
    ...
    @Bean
    @ConditionalOnClass(MetricsEndpoint.class) // spring-boot-micrometer-metrics
