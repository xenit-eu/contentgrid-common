...
abstract class MultiTenantOAuth2ResourceServerAutoConfigurationTest {

    private static final OidcTestServer OIDC_SERVER = new OidcTestServer();
    ...
    abstract WebApplicationContextRunner createContextRunner();

    abstract Class<?> getAutoconfigurationClass();
    ...
    void conditionalOnTrustedJwtIssuersProperty() {
        this.createContextRunner().run((context) -> assertThat(context)
                .hasNotFailed()
                .hasSingleBean(getAutoconfigurationClass())
