...
dependencies {
    "springBoot3Platform"(platform("org.springframework.boot:spring-boot-dependencies:4.1.1"))
    "springBoot4Platform"(platform("org.springframework.boot:spring-boot-dependencies:4.1.1"))
}